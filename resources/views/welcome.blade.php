...
<head>
    ...
    <style>
        ...
        .section-wrapper {
            ...
            .theme-dark & {
                background-color: hsl(from var(--bg-dark) h s 15%);
            }
        ...
        .feature-list {
            ...
            li {
                ...
                .material-icons {
                    ...
                    .theme-dark & {
                        box-shadow: 0 4px 6px rgba(255, 255, 255, 0.17);
                    }
                }
            }
        }
            ...
            <div class="nav-wrapper container">
                ...
                <div class="theme-toggle z-50">
                    ...
                    <button id="theme-toggle"
                        class="bg-gray-200 dark:bg-gray-700 p-2 rounded-full shadow-md focus:outline-none">
