...
<div class="container profile-wrapper">
    ...
    <div class="section-wrapper settings">
        ...
        <!-- Update Contacts -->
        <form method="POST" action="{{ route('profile.update_contact') }}" class="settings-form">
            @csrf
            <div class="input-field col s12">
            ...
            <div class="center-align">
                <button type="submit" class="btn blue">
                    <span class="material-icons">phone</span> Update Contact
                </button>
            </div>
        </form>
    </div>
    ...
    <style>
        ...
        .theme-light {
            ...
            &:is(.theme-dark) {
                ...
                input,
                textarea {
                    border: 1px solid hsl(222 17% 35%) !important;
                    background-color: hsl(222 23% 23%) !important;
                }
            }
